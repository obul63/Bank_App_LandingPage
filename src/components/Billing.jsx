    ...
    <section id="product" className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        <p className={`${styles.paragraph} mx-w-[470px] mt-5`}>
           Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis aliquam officia fugiat id dignissimos vero veritatis tempore nostrum sint voluptate. Nostrum voluptatibus illum delectus porro mollitia id aliquid eos provident.
        </p>
